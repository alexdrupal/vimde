...
" F7 - NERDTree
nmap <silent> <F7> :NERDTreeToggle [project_path]<CR>
vmap <silent> <F7> <esc>:NERDTreeToggle [project_path]<CR>i
imap <silent> <F7> <esc>:NERDTreeToggle [project_path]<CR>i
...
function! UPDATE_TAGS()
  let _f_ = expand("%:p")
  let _cmd_ = '"ctags -a -f [path_to_tags] --PHPkinds=+cf --totals --tag-relative " ' . '"' . _f_ . '"'
